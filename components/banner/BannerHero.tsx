    ...
    >
      ...
      <div className="w-full max-w-[1680px] flex flex-col items-center px-4 sm:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-white font-serif text-4xl sm:text-5xl md:text-6xl lg:text-heading1-semibold tracking-wide leading-tight">
            E-Commerce Store
          </h1>
          <p className="text-[#E5E5E5] text-base sm:text-body-medium max-w-2xl mx-auto leading-relaxed">
        ...
        >
          <Button
            variant="outline"
            className="bg-[#E5D3B3] text-[#1C1C1C] hover:bg-[#D4C2A2] text-base-medium px-8 py-6 rounded-none border-0 transition-colors duration-300"
          >
            SHOW NOW
          </Button>
          <Button
